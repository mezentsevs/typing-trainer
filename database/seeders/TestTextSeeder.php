...
EOT,
            ...
            'ru' => [
                ...
                [
                    'genre' => 'non-fiction',
                    'text' => 'Образование формирует личность и общество. Оно даёт знания, навыки и ценности, необходимые для жизни. Системы образования различаются по странам, но цель у них общая: подготовить людей к вызовам мира. В древности обучение было привилегией элиты, но сегодня оно доступно миллионам. Технологии изменили образование: онлайн-курсы и платформы сделали знания ближе. Однако качество образования остаётся проблемой в некоторых регионах. Учителя играют ключевую роль, вдохновляя учеников и развивая их потенциал. Навыки вроде слепой печати помогают студентам и профессионалам эффективно работать с информацией. Образование не заканчивается в школе - lifelong learning (обучение на протяжении всей жизни) становится нормой. Постоянное развитие позволяет адаптироваться к изменениям и достигать успеха.',
                ],
                [
                    'genre' => 'non-fiction',
