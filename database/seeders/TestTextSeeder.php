    ...
    public function run(): void
    {
        $texts = [
            ...
            'ru' => [
                ...
                [
                    'genre' => 'fiction',
                    'text' => 'Поезд мчался сквозь ночь, разрезая тьму. Вагон №7 был почти пуст, лишь несколько пассажиров дремали под стук колёс. Катя сидела у окна, глядя на мелькающие тени леса. Она возвращалась домой после долгого отсутствия, но что-то в этом рейсе вызывало тревогу. Мужчина напротив, в чёрном пальто, не сводил с неё глаз. Его лицо скрывала тень от шляпы, но Катя чувствовала его взгляд. Она попыталась отвлечься, листая книгу, но слова расплывались. Внезапно поезд дёрнулся и остановился. Свет мигнул и погас. Тишина. Затем шёпот из темноты: "Ты знаешь, зачем я здесь". Катя замерла. Голос был чужим, но знакомым. Она включила фонарик на телефоне, но луч осветил пустое сиденье напротив. Мужчина исчез. Паника нарастала. Катя двинулась к выходу, но двери вагона были заперты. Вдалеке послышались шаги. Кто-то приближался. Она спряталась за сиденьем, затаив дыхание. Фонарик погас, и тьма поглотила все. Когда свет вернулся, Катя увидела записку на своём месте: "Беги, пока можешь". Поезд снова тронулся, но теперь она знала - это не просто рейс домой. Это была ловушка, и кто-то в этом вагоне хотел её смерти.',
                ],
                [
                    'genre' => 'fiction',
